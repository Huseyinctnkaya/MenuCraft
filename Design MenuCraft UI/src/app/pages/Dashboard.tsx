...
import { Menu, Smartphone, Download, Shield, Users, ChevronDown, ChevronUp, AlertCircle, CheckCircle2, Star } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const trustFeatures = [
    { icon: Shield, text: '30-day money back guarantee', color: 'green' },
    { icon: Star, text: 'Built for Shopify by Shopify Experts', color: 'indigo' }
  ];
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="text-center space-y-4 hover:shadow-md transition-shadow cursor-pointer" onClick={feature.action}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" size="sm" className="w-full mt-4" onClick={() => navigate('/builder')}>
                Continue Setup
              </Button>
            </div>
          </Card>
