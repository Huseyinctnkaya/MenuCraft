...
import { Check, Zap, Rocket, Star, Shield, CreditCard, ArrowRight, LayoutGrid, X } from 'lucide-react';
import Card from '../components/ui/Card';
import Button from '../components/ui/Button';
import Badge from '../components/ui/Badge';
import logoImg from 'figma:asset/3faa9a57a36671cf37616b1a8141edc5d84c03e5.png';
...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      {/* Ana İçerik - Menü yüksekliği kadar padding ekledik */}
      <div className="pt-20">
